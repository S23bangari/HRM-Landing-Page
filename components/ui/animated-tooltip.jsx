      ...
      {items.map((item, idx) => (
        <div
          ...
          <img
            ...
            src={item.image}
            alt={item.name}
            className="relative !m-0 h-14 w-14 rounded-xl border-2 border-white object-cover object-top !p-0 transition duration-500 group-hover:z-30 group-hover:scale-105" />
        </div>
      ))}
    </>
  );
